                        ...
                        <div className="col-md-8">
                            ...
                            <div className="DishDetail">
                                <p>Salmon is rich in omega-3 fatty acids, which can help reduce inflammation, lower blood pressure, and decrease risk factors for diseases.
                                        Baked Salmon only takes 5 min to prepare, then you can just sit and wait.Salmon is rich in omega-3 fatty acids, which can help reduce inflammation, lower blood pressure, and decrease risk factors for diseases.Baked Salmon only takes 5 min to prepare, then you can just sit and wait. Salmon is rich in omega-3 fatty acids, which can help reduce inflammation, lower blood pressure, and decrease risk factors for diseases.Baked Salmon only takes 5 min to prepare, then you can just sit and wait.</p>
                            </div>
                        </div>
